...
//I also avare of problem that caused fast spin at fist start. I couldn't tried it but I think it can be solved by uncommenting the analogwrite line in setup 
//and transportig the define part below to DELAY HERE location on setup.
//NOTICE THAT I didn't tried it. I you copy the code without change code will be work as in video.
